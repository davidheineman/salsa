...
import pandas as pd
import torch
from lens_salsa.models.base import CometModel
from lens_salsa.models.metrics import RegressionMetrics
from lens_salsa.modules import FeedForward
from transformers.optimization import Adafactor
from lens_salsa.models.utils import Prediction, Target
...
class RegressionMetricMultiReference(CometModel):
    ...
    ) -> Union[Tuple[Dict[str, torch.Tensor], Dict[str, torch.Tensor]], Dict[str, torch.Tensor]]:
        """
    ...
    def training_step(
        ...
        batch_prediction = Target(score=torch.hstack(batch_prediction))
        new_batch_target = Target(score=torch.hstack(new_batch_target))
    ...
    def validation_epoch_end(self, *args, **kwargs) -> None:
        ...
        # This is the legacy implementation. I'm actually not sure why the above doesn't work.
