...
from lens_salsa.models.metrics import MCCMetric, RegressionMetrics
...
class UnifiedMetric(CometModel):
    ...
    def init_metrics(self):
        ...
        if self.hparams.word_level_training:
            # Train and Dev MCC
            self.train_mcc = MCCMetric(num_classes=self.num_token_spans, prefix="train")
            self.val_mcc = nn.ModuleList(
                [
                    MCCMetric(num_classes=self.num_token_spans, prefix=d)
